  ...
  <div class="container mt-3">
    ...
    <script>
        ...
        setTimeout(function() {
            ...
            var successDiv = document.getElementById('DBfeedbackSuccess');
            successDiv.classList.add("d-none");
            <?php } ?>

            <?php if ($showFeedbackDBerror) { ?>
            var errorDiv = document.getElementById('DBfeedbackError');
            ...
            <div class="modal fade modal-fullscreen-sm-down" id="newArticleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="submit" id="submitBtn" class="btn btn-primary value="Upload Image" name="submitNewArticle" value="Salva">
                    </div>
                    </div>
                </div>
            </div>
    ...
    <!-- New Fornitore modal -->
            ...
            <script>
                ...
                $(document).ready(function() {
                // Controlla se il parametro "openModal" è presente nell'URL
                const urlParams = new URLSearchParams(window.location.search);
                if (urlParams.get('openModal') === 'true' && urlParams.get('error') != 'true') {
                    // Apri il modal
